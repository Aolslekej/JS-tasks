...
let number = (a) => {
        if(a == getRandomInteger(0,11)){
            console.log('Вы выйграли!');
        }
        else if(a !== getRandomInteger(0,11)){
            console.log(`Вы не угадали, ваше число -  ${a}, а выпало ${getRandomInteger(0,11)}`);
        }
    }
